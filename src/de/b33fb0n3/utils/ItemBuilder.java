...
public class ItemBuilder {
    ...
    public ItemBuilder setBannerPattern(PatternType pattern2, DyeColor color) {
        try {
            List<Pattern> patterns2 = new ArrayList<Pattern>();
            BannerMeta im2 = (BannerMeta) is.getItemMeta();
            patterns2.add(new Pattern(color, pattern2));
            is.setItemMeta(im2);
        } catch (ClassCastException expected) {
        }
        return this;
